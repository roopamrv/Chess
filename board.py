...
bp = Piece('b', 'p', 'images/black_pawn.png')
wp = Piece('w', 'p', 'images/white_pawn.png')
bk = Piece('b', 'k', 'images/black_king.png')
wk = Piece('w', 'k', 'images/white_king.png')
br = Piece('b', 'r', 'images/black_rook.png')
wr = Piece('w', 'r', 'images/white_rook.png')
bb = Piece('b', 'b', 'images/black_bishop.png')
wb = Piece('w', 'b', 'images/white_bishop.png')
bq = Piece('b', 'q', 'images/black_queen.png')
wq = Piece('w', 'q', 'images/white_queen.png')
bkn = Piece('b', 'kn', 'images/black_knight.png')
wkn = Piece('w', 'kn', 'images/white_knight.png')
...
def create_board(board):
    board[0] = [Piece('b', 'r', 'images/black_rook.png'), Piece('b', 'kn', 'images/black_knight.png'),
                Piece('b', 'b', 'images/black_bishop.png'),
                Piece('b', 'q', 'images/black_queen.png'), Piece('b', 'k', 'images/black_king.png'),
                Piece('b', 'b', 'images/black_bishop.png'),
                Piece('b', 'kn', 'images/black_knight.png'), Piece('b', 'r', 'images/black_rook.png')]

    board[7] = [Piece('w', 'r', 'images/white_rook.png'), Piece('w', 'kn', 'images/white_knight.png'),
                Piece('w', 'b', 'images/white_bishop.png'),
                Piece('w', 'q', 'images/white_queen.png'), Piece('w', 'k', 'images/white_king.png'),
                Piece('w', 'b', 'images/white_bishop.png'),
                Piece('w', 'kn', 'images/white_knight.png'), Piece('w', 'r', 'images/white_rook.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'images/black_pawn.png')
        board[6][i] = Piece('w', 'p', 'images/white_pawn.png')
    return board
